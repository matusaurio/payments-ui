...
export const getAllPaymentsFromAPI = (): Promise<Response> => {
...
export const getAllPaymentsAxiosVersion = (): Promise<
  AxiosResponse<PaymentType[]>
> => {
...
export const addNewTransactionOld = (
  payment: PaymentType
